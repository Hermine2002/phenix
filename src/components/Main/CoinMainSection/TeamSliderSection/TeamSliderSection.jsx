...
// const testimonials = [
//   {
//     text: "1. Creative agency is the most tech valuable business resource we have ever purchased. Dude your stuff is the bomb! eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt to the explicabo.",
//     author: "Ahon Monsery",
...
//     position: "CEO AT TECH",
//     rating: 5,
//     image: "https://arino-laravel.laravel.com/storage/testimonial/tO9O78qrxmMUZQOciEGst2MOqarosQkqdNJufOJ9.jpg",
//   },
//   {
       ...
       <div className="dual-slider-container">
        ...
        <div className="text-slider">
          <div className="text-wrapper">
            <p className="testimonial-text">{t('home-section.testimonial_text')}</p>
            {/* <div className="stars">
