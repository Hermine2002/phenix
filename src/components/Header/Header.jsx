...
const Header = () => {
    ...
    const LanguageMobileDropdown = () => {
        ...
        return (
            <div className="relative w-48">
                <ul className="absolute z-10 mt-1 w-full bg-gray-800 border border-gray-600 rounded-md shadow-lg max-h-60 overflow-auto" style={{display: 'flex'}}>
                    {languages.map((lang) => (
                        <li
                            key={lang.code}
                            onClick={() => changeLanguage(lang.code)}
                ...
                <div className="box11">
                    ...
                    <div className="menu-box">
                        <ul className="nav-menu-icon">
                            ...
                            <li className="list"><Link to='/what-we-do' className="list">{t('header.what we do')}</Link>
                            </li>
